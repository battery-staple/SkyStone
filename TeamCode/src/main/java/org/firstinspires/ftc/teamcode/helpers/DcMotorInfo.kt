...
//
//    @Deprecated("Use encoderMode instead")
//    fun ensureEncoderIs(mode: DcMotor.RunMode) {
//        encoderMode = mode
//
//        /* depending on how long things take, this may be a superior implementation:
//
//        if (this.motor.mode != DcMotor.RunMode.RUN_WITHOUT_ENCODER) {
